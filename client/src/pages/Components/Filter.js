...
function Filters({ energisersData, setEnergisersData,originalData }) {

	const handleFilter10 = () => {
        console.log(energisersData,"10");
		const newFilter = originalData.filter((energiser) =>
        energiser.duration === 10);
	...
	return (
			...
			<div className="filter">
				...
				<button
					type="text"
					onClick={ handleFilter10}>
                         Filter duration 10mins
                 </button>
				<button
					type="text"
					onClick={ handleFilter12}>
                         Filter duration 12mins
                 </button>
				<button
					type="text"
					onClick={ handleFilter15}>
